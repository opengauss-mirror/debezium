 ...
 * The package name of the open source file has been modified.
 */
...
public interface DateTimeFormat {
    ...
    public static class ISODateTimeFormat implements DateTimeFormat {
        ...
        private static final DateTimeFormatter NON_ISO_LOCAL_DATE = new DateTimeFormatterBuilder()
                ...
                .toFormatter();
        private static final DateTimeFormatter NON_ISO_LOCAL_DATE_YEAR_OF_ERA = new DateTimeFormatterBuilder()
        ...
        private static final DateTimeFormatter TS_FORMAT = new DateTimeFormatterBuilder()
                ...
                .optionalEnd()
                .toFormatter();
        private static final DateTimeFormatter TS_FORMAT_WITH_ERA = new DateTimeFormatterBuilder()
                .append(NON_ISO_LOCAL_DATE_YEAR_OF_ERA)
                .appendLiteral(' ')
                .append(DateTimeFormatter.ISO_LOCAL_TIME)
                .optionalStart()
                .appendLiteral(" ")
        ...
        private static final DateTimeFormatter TS_TZ_FORMAT = new DateTimeFormatterBuilder()
                ...
                .optionalEnd()
                .toFormatter();
        private static final DateTimeFormatter TS_TZ_FORMAT_ERA = new DateTimeFormatterBuilder()
                .append(NON_ISO_LOCAL_DATE_YEAR_OF_ERA)
                .appendLiteral(' ')
                .append(DateTimeFormatter.ISO_LOCAL_TIME)
                .appendOffset("+HH:mm", "")
                ...
                .optionalEnd()
                .toFormatter();
        private static final DateTimeFormatter TS_TZ_FORMAT_YEAR_OF_ERA = new DateTimeFormatterBuilder()
                .append(NON_ISO_LOCAL_DATE_YEAR_OF_ERA)
                .appendLiteral(' ')
                .append(DateTimeFormatter.ISO_LOCAL_TIME)
                .appendOffset("+HH:mm", "")
        ...
        private static final DateTimeFormatter TS_TZ_WITH_SECONDS_FORMAT = new DateTimeFormatterBuilder()
                ...
                .optionalEnd()
                .toFormatter();
        private static final DateTimeFormatter TS_TZ_WITH_SECONDS_FORMAT_ERA = new DateTimeFormatterBuilder()
                .append(NON_ISO_LOCAL_DATE_YEAR_OF_ERA)
                .appendLiteral(' ')
                .append(DateTimeFormatter.ISO_LOCAL_TIME)
                .appendOffset("+HH:MM:SS", "")
        ...
        private static final DateTimeFormatter DATE_FORMAT_OPT_ERA = new DateTimeFormatterBuilder()
                ...
                .optionalEnd()
                .toFormatter();
        private static final DateTimeFormatter DATE_FORMAT_OPT_WITH_YEAR_OF_ERA = new DateTimeFormatterBuilder()
                .append(NON_ISO_LOCAL_DATE_YEAR_OF_ERA)
                .optionalStart()
                .appendLiteral(' ')
                .appendText(ChronoField.ERA, TextStyle.SHORT)
        ...
        public LocalDate date(final String s) {
            return format(DATE_FORMAT_OPT_ERA_PATTERN_HINT, s, () -> {
                if (isBcOrAdEra(s)) {
                    return LocalDate.parse(s, DATE_FORMAT_OPT_WITH_YEAR_OF_ERA);
                }
        ...
        public Instant timestampToInstant(String s) {
            return format(TS_FORMAT_PATTERN_HINT, s, () -> {
                    if (isBcOrAdEra(s)) {
                        return LocalDateTime.from(TS_FORMAT_WITH_ERA.parse(s)).toInstant(ZoneOffset.UTC);
                    }
        ...
        // The timestamp could contain BC or AD suffix: 2000-01-01 00:00:00 BC
        private boolean isBcOrAdEra(String s) {
            if (s == null) {
                return false;
            }
            return s.contains(" BC") || s.contains(" AD");
        }
        ...
        public OffsetDateTime timestampWithTimeZoneToOffsetDateTime(String s) {
            return format(TS_TZ_FORMAT_PATTERN_HINT, s, () -> {
                ...
                if (isBcOrAdEra(s)) {
                    try {
                        parsedTimestamp = TS_TZ_FORMAT_ERA.parse(s);
                    } catch (DateTimeParseException e) {
                        parsedTimestamp = TS_TZ_WITH_SECONDS_FORMAT_ERA.parse(s);
                    }
                } else {
                    try {
