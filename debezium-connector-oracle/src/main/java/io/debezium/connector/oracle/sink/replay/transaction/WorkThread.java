...
public class WorkThread extends Thread {
    ...
    private final BlockingQueue<String> feedBackQueue;
     ...
     */
    public WorkThread(ConnectionInfo connectionInfo, BlockingQueue<String> feedBackQueue, int index) {
    ...
    private void feedBackModifiedTable() {
        if (!txn.getIsDml() && SqlTools.isCreateOrAlterTableStatement(txn.getSqlList().get(1))) {
            String schemaName = txn.getSourceField().getSchema();
